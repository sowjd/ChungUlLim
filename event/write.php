        ...
        <div id="event_write">
            <form action="write_ok.php" method="post">
                    <table id="eventWrite">
                        ...
                        <tr>
                            <td height="30"><textarea name="title" id="utitle" class="form-control form-control-sm" rows="1"></textarea>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td height="30"><textarea name="term" id="uname" class="form-control form-control-sm" id="inh" rows="1"></textarea>
                        </tr>
                        <tr>
                            <td class="tb"><label for="ucontent">Event</label></td>
                        </tr>
                        <tr>
                            <td height="30"><textarea name="event" id="ucontent" class="form-control form-control-sm" rows="6"></textarea></td>
                        </tr>
                    </table>
                <br>
                <div class="bt_se">
